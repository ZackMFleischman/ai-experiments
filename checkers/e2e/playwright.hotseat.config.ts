// ported from lex/e2e/playwright.hotseat.config.ts (adapted)
// validate:hotseat runs against the DEV server — the gallery is stripped from
...
export default defineConfig({
  ...
  webServer: {
    command: 'pnpm --filter @checkers/app dev --port 5223 --strictPort --host 127.0.0.1',
