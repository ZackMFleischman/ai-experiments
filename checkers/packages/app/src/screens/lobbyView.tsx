// checkers's lobby presentation: the grouped game list lives in
// @parlor/web/lobby-ui — this file binds checkers's three slots (the MiniBoard
  ...
  return (
    <Stack alignItems="center" spacing={1} sx={{ mt: 6, textAlign: 'center' }} data-testid="lobby-empty">
      <Box aria-hidden sx={{ mb: 1 }}>
        <MiniBoard board={initialCheckers().board} size={88} />
      </Box>
