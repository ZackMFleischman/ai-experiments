...
export function Landing() {
  return (
    <ParlorLanding hero={<LandingHero />} name="CHECKERS" tagline="The Viking siege game, for two." />
  );
}

export function LandingLayout({ children }: { children: ReactNode }) {
  return (
    <ParlorLandingLayout hero={<LandingHero />} name="CHECKERS" tagline="The Viking siege game, for two.">
      {children}
    </ParlorLandingLayout>
  );
}
