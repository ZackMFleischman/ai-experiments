// ported from lex/scripts/check-docs.mjs (adapted for tafl's doc set)
// Docs policy lint (IMPLEMENTATION.md §7) — wired into `pnpm typecheck` and CI.
// Fails on: (a) a §7 line budget exceeded, (b) any .md under tafl/ outside
...
// they're factory output, not part of tafl's authored doc set.
