// ported from hive/packages/app/src/sync/AppSyncProviders.tsx (adapted)
// Full-mode provider stack: the only component that touches the firebase SDK,
// loaded lazily by a consumer's App when its full-mode flag is set. Auth state
...
const TEST_PASSWORD = 'parlor-test-password';
