// Auth seam (T4.1). This module is firebase-free on purpose: screens read auth
// through this context, and only the lazy full-mode provider (AppSyncProviders)
// ever imports the firebase SDK — that's what keeps the static hot-seat bundle
// clean (scripts/check-bundle.mjs).
...
/** Default context value: the static hot-seat build has no auth at all. */
