// iOS install coach mark (T5.2, DESIGN §7): Web Push on iOS needs the app on
// the Home Screen — shown once, dismissible. Firebase-free (gallery-safe).
  ...
  return (
    <Card variant="outlined" sx={{ borderColor: 'primary.main' }} data-testid="install-coach-mark">
      <CardContent sx={{ display: 'flex', alignItems: 'flex-start', gap: 1.5, '&:last-child': { pb: 2 } }}>
        ...
        <IconButton size="small" aria-label="dismiss" onClick={onDismiss} data-testid="dismiss-coach-mark">
