// Hive turn awareness (T5.4, DESIGN §7): the badge logic lives in
// @parlor/web/lobby-ui — this file binds hive's base title ("(n) HIVE") and
// re-exports the shared actionable count (which must stay in step with the
// server's countActionable in functions/src/notify.ts). The full-mode lobby
// feeds it the count. Firebase-free.
import {
