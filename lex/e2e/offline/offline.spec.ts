// ported from hive/e2e/offline/offline.spec.ts (adapted)
...
// game read-only (Firestore persistent cache) and the hot-seat game (and its
// precached dictionary) fully playable.
