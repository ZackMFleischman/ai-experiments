...
// the game doc is still status:'open' (the board — and your rack — stay
// withheld, §8.10). The invite stays retrievable here as a link AND a bare
// code the friend can type in. Firebase-free.
          ...
          <Stack spacing={2.5} alignItems="center" sx={{ py: 1 }}>
            ...
            {challengeName ? (
              <Typography color="text.secondary" align="center">
                Your challenge is out to {challengeName} — racks are dealt the moment they accept.
              </Typography>
            ) : code ? (
              <>
                <Typography color="text.secondary" align="center">
      ...
      <Card sx={{ width: '100%', maxWidth: 440 }} data-testid="challenge-received">
        <CardContent>
          <Stack spacing={2.5} alignItems="center" sx={{ py: 1 }}>
            ...
            <Typography color="text.secondary" align="center">
              Accept to take the open seat — your rack is waiting.
            </Typography>
            <Stack direction="row" spacing={1}>
              <Button
                color="error"
