...
// "(n) LEX" plus the app icon badge where the Badging API exists.
// Firebase-free; the full-mode lobby feeds it the actionable count.
 ...
 * countActionable (@parlor/server notify) — the push carries the same
