...
import { canonicalBagOrder, FirestoreTransport, type GameMeta } from './firestoreTransport';
      ...
      .then(async (info) => {
        ...
        built = new GameController(
          transport,
          {
            ...
            hardMode: info.options.hardMode === true,
  ...
  return (
    <Box sx={{ height: '100dvh', display: 'flex', flexDirection: 'column' }}>
      <GameBoard
        ...
        seatNames={[meta.playerNames.p0 ?? 'Player 1', meta.playerNames.p1 ?? 'Player 2']}
        onRematch={rematch}
