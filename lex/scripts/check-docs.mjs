...
// this file owns only lex's closed doc set, budgets, and skip list.
...
checkDocs({
  ...
  skipDirs: ['node_modules', 'dist', 'lib', 'artifacts', 'coverage', 'test-results', 'playwright-report', 'emulator-seed', '.firebase', 'words', 'generated'],
});
