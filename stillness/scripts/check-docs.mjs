// ported from sudoku/scripts/check-docs.mjs (adapted for stillness's doc set)
// Docs policy lint (IMPLEMENTATION.md §7) — wired into `pnpm typecheck` and CI.
// Fails on: (a) a §7 line budget exceeded, (b) any .md under stillness/
// outside the closed doc set, (c) append-minded "Update (" / "UPDATE:"
// markers in DESIGN.md / IMPLEMENTATION.md.
