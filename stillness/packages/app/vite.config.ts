// modeled on sudoku/packages/app/vite.config.ts (no engine, no dictionaries,
// no firebase — stillness is fully static and offline by construction)
  ...
  plugins: [
    ...
    VitePWA({
      ...
      workbox: {
        ...
        // SPA fallback so a cold offline start on /sit still boots.
        navigateFallback: '/index.html',
      },
      manifest: {
        name: 'Stillness',
        short_name: 'Stillness',
        description: 'A quiet meditation timer. Nothing else.',
        theme_color: '#4e7d5b',
