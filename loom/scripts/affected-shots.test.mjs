...
describe("repoRel", () => {
  it("strips a leading loom/ and normalizes backslashes", () => {
    expect(repoRel("loom/content/scenes/pulse.scene.ts")).toBe("content/scenes/pulse.scene.ts");
    expect(repoRel("loom\\content\\inputs.ts")).toBe("content/inputs.ts");
